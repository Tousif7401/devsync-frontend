...
// Custom SVG Icon Components - Distinctive, non-generic designs
const AnalyticsIcon = () => (
  <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
    <circle cx="24" cy="24" r="20" fill="white" opacity="0.1"/>
    ...
    <rect x="10" y="34" width="28" height="2" rx="1" fill="white" opacity="0.3"/>
  </svg>
);
...
const AutomationIcon = () => (
  <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
    <circle cx="24" cy="24" r="20" fill="white" opacity="0.1"/>
    <path d="M20 12 L28 20 L20 20 L20 12Z" fill="white"/>
    <path d="M28 28 L20 36 L28 36 L28 28Z" fill="white"/>
    <circle cx="24" cy="24" r="4" stroke="white" strokeWidth="2" fill="none"/>
    <path d="M32 24 L40 24 M36 20 L40 24 L36 28" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M8 24 L16 24 M12 20 L8 24 L12 28" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);
...
const PrivacyIcon = () => (
  <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
    ...
    <path d="M18 18 L30 18 L30 22 L18 22 Z" fill="white" opacity="0.3"/>
    <path d="M18 26 L30 26 L30 30 L18 30 Z" fill="white" opacity="0.5"/>
...
const MultiPlatformIcon = () => (
  <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
    ...
    <circle cx="12" cy="32" r="4" fill="white" opacity="0.6"/>
    <circle cx="36" cy="32" r="4" fill="white" opacity="0.6"/>
    <circle cx="12" cy="16" r="4" fill="white" opacity="0.6"/>
    <path d="M24 18 L30 14" stroke="white" strokeWidth="2" opacity="0.5"/>
    <path d="M24 30 L18 34" stroke="white" strokeWidth="2" opacity="0.5"/>
    <path d="M30 18 L34 16" stroke="white" strokeWidth="2" opacity="0.5"/>
    <path d="M18 30 L14 32" stroke="white" strokeWidth="2" opacity="0.5"/>
  </svg>
);
...
const HistoryIcon = () => (
  <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
    ...
    <circle cx="24" cy="24" r="8" stroke="white" strokeWidth="2" fill="none" opacity="0.5"/>
    <circle cx="24" cy="24" r="12" stroke="white" strokeWidth="2" fill="none" opacity="0.3"/>
    <circle cx="24" cy="24" r="16" stroke="white" strokeWidth="2" fill="none" opacity="0.15"/>
  </svg>
);
...
const GitHubIcon = () => (
  <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
    ...
    <circle cx="16" cy="32" r="2" fill="white" opacity="0.7"/>
    <circle cx="32" cy="32" r="2" fill="white" opacity="0.7"/>
    <path d="M20 20 L28 28 M28 20 L20 28" stroke="white" strokeWidth="2" strokeLinecap="round" opacity="0.5"/>
  </svg>
);
                  ...
                  {features.map((feature) => {
                    ...
                    return (
                      <Card key={feature.id} customClass="p-4 sm:p-5 flex flex-col justify-between cursor-pointer hover:scale-105 transition-transform group relative" onClick={() => setSelectedFeature(feature)}>
                        <div>
                          <div className={`w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-gradient-to-br ${feature.color} flex items-center justify-center mb-2 sm:mb-3 p-2 sm:p-3`}>
                            <IconComponent />
                          </div>
                        ...
                        <div className={`text-[10px] sm:text-xs font-semibold bg-gradient-to-r ${feature.color} bg-clip-text text-transparent`}>
                          {feature.stat}
                        </div>
                        {/* Tooltip */}
            ...
            >
              ...
              >
                ...
                <div className="flex items-start gap-4 mb-6">
                  <div className={`w-20 h-20 rounded-2xl bg-gradient-to-br ${selectedFeature.color} flex items-center justify-center flex-shrink-0 p-4`}>
