            ...
            <div ref={timelineRef} className="relative px-4 sm:px-6 pt-20 sm:pt-24 md:pt-28 pb-20 sm:pb-24 md:pb-28 w-full">
              ...
              {steps.map((step, index) => (
                ...
                >
                  ...
                  {/* Dot */}
                  <div className={`absolute left-5 md:left-1/2 -translate-x-1/2 w-4 h-4 rounded-full border-4 z-10 transition-all duration-300 ${
                    activeStep === index ? 'bg-draftrPurple border-white scale-125' : 'bg-white border-draftrPurple'
                  }`} />

                  {/* Card */}
                  <div className={`w-full md:w-[38%] pl-8 md:pl-0 ${index % 2 === 0 ? 'md:pr-12' : 'md:pl-12'} ml-12 sm:ml-16 md:ml-0`}>
