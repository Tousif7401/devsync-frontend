...
const contentOutputCards = [
  {
    ...
    date: "2 min read",
    iconClassName: "",
    titleClassName: "text-white font-geist font-semibold",
    className:
      "[grid-area:stack] sm:hover:-translate-y-20 hover:-translate-y-14 before:absolute before:w-[100%] before:outline-1 before:rounded-xl before:outline-white/10 before:h-[100%] before:content-[''] before:bg-blend-overlay before:bg-white/[0.03]/30 grayscale-[100%] hover:before:opacity-0 before:transition-opacity before:duration-700 hover:grayscale-0 before:left-0 before:top-0",
  },
  {
  ...
  return (
    <section id="content-output-types" className="relative z-10 py-20 sm:py-24 px-4 sm:px-6 bg-transparent overflow-hidden w-full">
      <div className="max-w-7xl mx-auto w-full">
        ...
        >
          ...
          >
            <div>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4 sm:mb-6 font-geist break-words">
                Three Content Types, One Powerful Platform
              </h2>
              <p className="text-base sm:text-lg md:text-xl text-white/60 leading-relaxed font-geist break-words">
            ...
            <div className="space-y-4 sm:space-y-6">
              <div className="flex items-start gap-3 sm:gap-4">
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-buttons bg-white/[0.03] border border-white/10 flex items-center justify-center shrink-0 hover:bg-brand hover:text-white hover:border-brand transition-colors duration-300">
                  <FileText className="w-5 h-5 sm:w-6 sm:h-6 text-white group-hover:text-white" />
                </div>
                <div>
                  <h3 className="text-lg sm:text-xl font-bold text-white mb-2 font-geist break-words">Technical Deep Dives</h3>
              ...
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div>
                  <h3 className="text-lg sm:text-xl font-bold text-white mb-2 font-geist break-words">Quick Updates</h3>
                  <p className="text-white/60 leading-relaxed break-words">
              ...
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div>
                  <h3 className="text-lg sm:text-xl font-bold text-white mb-2 font-geist break-words">Visual Stories</h3>
                  <p className="text-white/60 leading-relaxed break-words">
