...
const AnalyticsDemo = () => {
  ...
  return (
    <div className="bg-black/70 backdrop-blur-sm rounded-cards border border-white/15 p-6 h-[360px] flex items-center justify-center relative overflow-hidden">
      <div className="relative z-10 w-full">
          ...
          <div className="relative">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              ...
              >
                ...
                <div className="text-xs text-white/60 mt-1">{metrics[activeMetric].label}</div>
              </motion.div>
            </div>
          </div>
        </div>
          ...
          {metrics.map((metric, i) => (
            <motion.button
              ...
              animate={{
                ...
                backgroundColor: i === activeMetric ? metric.color : 'rgba(255,255,255,0.3)'
              }}
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-navigation bg-white/5 border border-white/15">
        ...
        <div className="flex justify-center gap-2 mt-6">
          {phases.map((_, i) => (
            <motion.div
              ...
              animate={{
                scale: i === phase ? 1.3 : 1,
                backgroundColor: i === phase ? '#ff9900' : 'rgba(255,255,255,0.3)'
              }}
              transition={{ duration: 0.3 }}
      ...
      <div className="flex items-start gap-6 w-full max-w-lg relative">
        ...
        <div className="flex-1 relative" id="repo-section">
          <div className="text-center mb-4">
            <div className="text-xs text-white/60 uppercase tracking-wide mb-2">Your Repository</div>
            <div className="w-16 h-16 mx-auto rounded-medium bg-white/5 border border-white/15 flex items-center justify-center relative z-10" id="repo-icon">
          ...
          <div className="space-y-2">
            {dataItems.map((item, i) => (
              <motion.div
                ...
                className={`px-3 py-2 rounded-small text-xs font-mono bg-black/30 ${
                  item.blocked
                    ? 'bg-red-900/30 text-red-400 border border-red-500/30'
                    : 'bg-black/30 text-emerald-400 border border-emerald-500/30'
                }`}
              >
        ...
        <div className="relative flex items-center mt-8">
          <motion.div
            ...
            className="w-20 h-20 rounded-medium bg-white/5 border-2 border-emerald-500/40 flex items-center justify-center relative overflow-hidden"
        ...
        <div className="flex-1 relative" id="devsync-section">
          <div className="text-center mb-4">
            <div className="text-xs text-white/60 uppercase tracking-wide mb-2">DevSync AI</div>
            <div className="w-16 h-16 mx-auto rounded-medium bg-white/5 border border-white/15 flex items-center justify-center relative z-10 p-2" id="devsync-icon">
          ...
          <div className="space-y-2">
            {dataItems.filter(d => !d.blocked).map((item, i) => (
              <motion.div
                ...
                className="px-3 py-2 rounded-small text-xs font-mono bg-highlightOrange/20 text-white border border-highlightOrange/30"
              >
...
const MultiPlatformDemo = () => {
  ...
  return (
    <div className="bg-black/70 backdrop-blur-sm rounded-cards border border-white/15 p-6 h-[360px] flex flex-col items-center relative overflow-hidden">
      ...
      <div className="relative w-72 h-48" style={{ perspective: '1000px' }}>
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="absolute inset-0 rounded-cards border-2 p-5 flex flex-col items-center justify-center bg-white/5"
            style={{
          ...
          >
            ...
            <motion.div
              ...
              className="text-xs text-white/60 text-center leading-relaxed px-2 line-clamp-2"
            >
      ...
      <div className="flex gap-2 mt-3">
        {stages.map((_, i) => (
          <motion.div
            ...
            animate={{
              width: stage === i ? 32 : 8,
              backgroundColor: stage === i ? (stages[stage].color === '#111111' ? '#ff9900' : stages[stage].color) : 'rgba(255,255,255,0.3)'
            }}
            transition={{ duration: 0.3 }}
      ...
      <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-4 pb-4">
        <motion.div
          animate={{
            ...
            borderColor: stage === 1 ? '#0077b5' : 'rgba(255,255,255,0.15)'
          }}
          transition={{ duration: 0.3 }}
          className="w-10 h-10 rounded-medium bg-white/5 border-2 border-white/15 flex items-center justify-center"
        >
        ...
        <motion.div
          animate={{
            ...
            borderColor: stage === 2 ? '#111111' : 'rgba(255,255,255,0.15)'
          }}
          transition={{ duration: 0.3 }}
          className="w-10 h-10 rounded-medium bg-white/5 border-2 border-white/15 flex items-center justify-center"
        >
        ...
        <motion.div
          animate={{
            ...
            borderColor: stage === 3 ? '#e1306c' : 'rgba(255,255,255,0.15)'
          }}
          transition={{ duration: 0.3 }}
          className="w-10 h-10 rounded-medium bg-white/5 border-2 border-white/15 flex items-center justify-center"
        >
...
const HistoryDemo = () => {
  ...
  return (
    <div className="bg-black/70 backdrop-blur-sm rounded-cards border border-white/15 p-5 h-[360px] flex flex-col overflow-hidden">
      {/* Header */}
      <div className="flex items-center justify-between mb-3 flex-shrink-0">
        <div>
          <h3 className="text-white font-semibold text-base">Your Generated Posts</h3>
          <p className="text-white/60 text-xs">Click to reuse or edit</p>
        </div>
      ...
      <div className="flex-1 flex gap-3 min-h-0">
          ...
          {posts.map((post, i) => (
            <motion.div
              ...
              className={`p-2.5 rounded-small cursor-pointer border transition-all ${
                i === selectedPost ? 'border-highlightOrange/40' : 'border-white/15 hover:border-white/25'
              }`}
            >
              <div className="flex items-center gap-2 mb-1">
                ...
                />
                <div className="text-xs font-medium text-white/60 truncate">{post.platform}</div>
              </div>
        ...
        <div className="flex-1 relative min-h-0">
          {posts.map((post, i) => (
            ...
            >
              {/* Platform Header */}
              <div className="flex items-center gap-2 mb-3 pb-3 border-b border-white/15 flex-shrink-0">
                <img
                  src={post.logo}
                  alt={post.platform}
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-white/60 text-[10px]">Generated from your commit</p>
                </div>
              </div>

              {/* Post Content Preview */}
              <div className="flex-1 bg-white/5 rounded-small p-3 mb-3 flex-shrink-0 border border-white/15">
                <div className="text-white text-xs font-medium mb-1">{post.title}</div>
                <div className="text-white/60 text-[11px] leading-relaxed line-clamp-2">{post.preview}</div>
              </div>

              {/* Stats */}
              <div className="flex gap-2 mb-3 flex-shrink-0">
                <div className="flex-1 text-center p-1.5 rounded-small bg-white/5 border border-white/15">
                  <div className="text-highlightOrange text-xs font-bold">{post.engagement}</div>
                  <div className="text-white/60 text-[9px]">Engagement</div>
                </div>
                <div className="flex-1 text-center p-1.5 rounded-small bg-white/5 border border-white/15">
                  <div className="text-highlightOrange text-xs font-bold">{post.reach}</div>
                  <div className="text-white/60 text-[9px]">Reach</div>
                </div>
              </div>
              ...
              <div className="flex gap-2 flex-shrink-0">
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="flex-1 py-2 rounded-small bg-actionBlack text-white text-xs font-medium flex items-center justify-center gap-1.5"
                >
                  <span>♻️</span> Reuse
                </motion.button>
                <motion.button
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className="flex-1 py-2 rounded-small bg-white/5 border border-white/15 text-white text-xs font-medium flex items-center justify-center gap-1.5 hover:bg-white/10"
                >
                  <span>✏️</span> Edit
                </motion.button>
              </div>
...
const GitHubDemo = () => {
  ...
  return (
    <div className="bg-black/70 backdrop-blur-sm rounded-cards border border-white/15 p-6 h-[360px] flex flex-col items-center justify-center relative overflow-hidden">
  ...
  return (
    <section className="relative z-10 py-24 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4 font-geist">
            Powerful Features
          </h2>
                ...
                <div className={isEven ? 'order-1' : 'order-2 lg:order-1'}>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-4">
                      <div className={`w-14 h-14 rounded-medium bg-offWhiteSage border border-white/15 flex items-center justify-center`}>
                    ...
                    <div className="flex flex-wrap gap-3">
                      {feature.stats.map((stat, idx) => (
                        <div
                          key={idx}
                          className="bg-offWhiteSage rounded-small border border-white/15 px-4 py-2"
                        >
