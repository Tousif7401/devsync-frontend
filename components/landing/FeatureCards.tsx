...
// Titan Palette: Midnight Ink (white) + Canvas White (#ffffff) + Highlight Orange (#00d2ff)
const AnalyticsIcon = () => (
  <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
    ...
    <circle cx="36" cy="22" r="2.5" fill="#00d2ff"/>
...
const AutomationIcon = () => (
  <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
    ...
    <circle cx="24" cy="24" r="4" stroke="#00d2ff" strokeWidth="2.5" fill="none"/>
    <circle cx="24" cy="24" r="1.5" fill="#00d2ff"/>
...
const PrivacyIcon = () => (
  <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
    ...
    <circle cx="28" cy="16" r="2.5" fill="#00d2ff"/>
  </svg>
);
...
const MultiPlatformIcon = () => (
  <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
    <circle cx="24" cy="24" r="20" fill="white" opacity="0.08"/>
    <circle cx="24" cy="24" r="6" fill="#00d2ff"/>
...
const HistoryIcon = () => (
  <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
    ...
    <circle cx="24" cy="24" r="3" fill="#00d2ff"/>
...
const features = [
  ...
  },
  {
    ...
    color: 'from-[#00d2ff]/90 to-[#e68a00]/80',
  ...
  },
  {
    ...
    color: 'from-canvasWhite to-[#00d2ff]/60',
...
export default function FeatureCards() {
  ...
  return (
    <section id="powerful-features" className="relative z-10 py-20 sm:py-24 px-4 sm:px-6 overflow-hidden w-full bg-transparent">
      <div className="max-w-7xl mx-auto w-full">
        ...
        >
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 font-geist break-words">
            Powerful Features
          </h2>
          <p className="text-base sm:text-lg md:text-xl text-white/60 max-w-2xl mx-auto break-words">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 md:gap-16 items-center">
          ...
          >
            <div>
              <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4 sm:mb-6 font-geist break-words">
                Everything You Need to Grow Your Brand
              </h3>
              <p className="text-base sm:text-lg md:text-xl text-white/60 leading-relaxed break-words">
            ...
            <div className="pt-4">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/[0.03] border border-white/15">
                <span className="text-white text-sm font-medium font-geist">Click cards for details</span>
              </div>
            </div>
          </motion.div>
                  ...
                  {features.map((feature) => {
                    ...
                    return (
                      <Card key={feature.id} customClass="p-4 sm:p-5 flex flex-col justify-between cursor-pointer hover:scale-105 transition-transform group relative" onClick={() => setSelectedFeature(feature)}>
                        <div>
                          <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-full border-2 border-white/10 bg-transparent flex items-center justify-center mb-2 sm:mb-3 p-2 sm:p-3 hover:bg-white/[0.03] hover:border-white/15 transition-colors">
                            <IconComponent />
                          </div>
                          <h3 className="text-base sm:text-lg font-bold text-white mb-1.5 sm:mb-2 font-geist">{feature.title}</h3>
                          <p className="text-white/60 text-[10px] sm:text-xs leading-relaxed">{feature.description}</p>
                        </div>
                        ...
                        <div className="absolute -top-10 left-1/2 -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
                          <div className="bg-white/10 backdrop-blur-md border border-white/20 text-white text-xs font-semibold px-3 py-1.5 rounded-buttons whitespace-nowrap shadow-lg">
                            Click me!
                            <div className="absolute top-full left-1/2 -translate-x-1/2 -mt-1 w-2 h-2 bg-white/10 border-b border-r border-white/20 rotate-45"></div>
                          </div>
                        </div>
                      </Card>
                    );
        ...
        <AnimatePresence>
          {selectedFeature && (
            <motion.div
              ...
              className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/80/70 backdrop-blur-sm"
            ...
            >
              <motion.div
                ...
                className="bg-black/90 border border-white/15 rounded-cards p-8 max-w-2xl w-full relative max-h-[90vh] overflow-y-auto [&::-webkit-scrollbar]:hidden"
                onClick={(e) => e.stopPropagation()}
              >
                {/* Close Button */}
                <button
                  onClick={() => setSelectedFeature(null)}
                  className="absolute top-4 right-4 w-10 h-10 rounded-full bg-white/[0.03] hover:bg-white/10 flex items-center justify-center text-white/60 hover:text-white transition-colors z-10"
                >
                  <X className="w-5 h-5" />
                </button>
                ...
                <div className="flex items-start gap-4 mb-6">
                  <div className="w-20 h-20 rounded-cards bg-white/[0.03] border border-white/10 flex items-center justify-center flex-shrink-0 p-4">
                    <selectedFeature.icon />
                  </div>
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold text-white mb-2 font-geist">{selectedFeature.title}</h3>
                    <p className="text-white/60 text-sm leading-relaxed">{selectedFeature.description}</p>
                  </div>
                </div>

                {/* Detail Title */}
                <div className="mb-4">
                  <h4 className="text-lg font-semibold text-white mb-2 font-geist">{selectedFeature.detailTitle}</h4>
                  <p className="text-white/60 leading-relaxed">{selectedFeature.detailContent}</p>
                </div>
                ...
                <div className="grid grid-cols-3 gap-4 pt-6 border-t border-white/10">
                  {selectedFeature.stats.map((stat) => (
                    <div key={stat.label} className="text-center">
                      <div className="text-2xl font-bold text-white mb-1 font-geist">
                        {stat.value}
                      </div>
                      <div className="text-xs text-white/60 font-geist">{stat.label}</div>
                    </div>
                  ))}
                </div>
              </motion.div>
